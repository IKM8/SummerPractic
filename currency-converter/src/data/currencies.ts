...
export const currencies: Currency[] = [
  {
    ...
    symbol: 'zł',
    description:
      'The Polish Zloty is the official currency of Poland. It is issued by the National Bank of Poland.',
  },
  {
    code: 'JPY',
    title: 'Japanese Yen',
  ...
  },
  {
    ...
    symbol: 'CA$',
    description:
      'The Canadian Dollar is the official currency of Canada. It is often referred to as the loonie.',
  },
  {
    code: 'USD',
    title: 'US Dollar',
